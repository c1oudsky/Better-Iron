...
![](image1.png)
![](image2.png)
This mod also introduces a bunch of customizable values which include (but are not limited to) iron armor and tools durability, gold pickaxe harvest level and sword damage and chainmall armor protection and ecnhantability values.
